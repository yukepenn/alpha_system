# Governance Template Placeholders

This directory stores governance object and report templates added by
`ALPHA_RESEARCH_GOVERNANCE_MVP` phases.

Current object templates:

- `alpha_spec.template.yaml`
