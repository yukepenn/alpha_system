# FUTCORE-P10 Liquidity PA AlphaSpec 03
...
```json
{
  "alpha_spec_id": "aspec_928e60d5096d2383a25f66c6",
  "hypothesis_id": "hyp_849b1622d91691c40417acb8",
  "target_instruments": [
    "ES",
    "NQ",
    "RTY"
  ...
  "data_assumptions": {
    ...
    "focus": "Wick rejection beyond a prior high or low with explicit body/wick thresholds.",
    ...
    "draft_trigger_logic": "High-side rejection requires high >= prior_range_high_N20 + one tick, upper_wick/range >= 0.60, abs(close-open)/range <= 0.35, and close <= prior_range_high_N20; low-side rejection mirrors the wick and close rules around prior_range_low_N20.",
    "horizon_policy": {
  ...
  "exclusion_rules": [
    ...
    "Exclude zero-range bars and bars whose body or wick components cannot be computed from completed OHLC values."
  ],
  "timestamp_assumptions": {
    "decision_timestamp": "Decision is after a completed sweep bar that also satisfies the objective rejection-wick ratio and body-size limits against the swept level.",
    "available_ts_usage": {
  ...
  "expected_failure_modes": [
    ...
    "Wick-ratio thresholds may be unstable across instruments and sessions, especially when one-tick ranges or thin-session bars dominate the candidate set."
  ],
  "promotion_criteria": [
    ...
    "Later diagnostics must report rejection-wick ratio buckets, body-ratio buckets, and zero-range exclusions before any review continuation."
  ],
  "created_by": "Hypothesis Scout:rq.p10.liquidity_pa_drafting:wick_rejection_sweep",
