...
- Post-closeout data work completed: Task 1A read-only IBKR connector
  (PR #96) and Task 1B resumable backfill/materialize path with first real
  local-only DatasetVersion `dsv_ibkr_es_nq_rty_eth_20260603_v1` (PR #97).
