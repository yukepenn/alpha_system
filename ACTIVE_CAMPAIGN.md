...
Current phase: `DATA-P15` - Canonical 1m Bar Contract
Last completed phase: `DATA-P14` - Parser and Parsed Bar Records
Last completed status: `PASS_WITH_WARNINGS`
Passing phases: `15/25`
...
Note: Projected after DATA-P14 merge.
