...
Campaign: `campaigns/ALPHA_RESEARCH_GOVERNANCE_MVP`
Workflow: `workflow2`
Run: `2026-06-03T135209Z_ALPHA_RESEARCH_GOVERNANCE_MVP`
Status: `executing`

Current phase: `ARGOV-P17` - Unsupported-Claim Guard and Governance Report Templates
Last completed phase: `ARGOV-P16` - Governance CLI and Validation Tools
Last completed status: `PASS_WITH_WARNINGS`
Passing phases: `17/20`
...
Note: Projected after ARGOV-P16 merge.
