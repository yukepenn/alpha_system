...
Current phase: `DATA-P10` - ES/NQ/RTY Main Batch Pull Plan
Last completed phase: `DATA-P09` - Raw Local Data Lake Layout
Last completed status: `PASS_WITH_WARNINGS`
Passing phases: `10/25`
...
Note: Projected after DATA-P09 merge.
