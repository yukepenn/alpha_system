...
Current phase: `ARGOV-P02` - Governance IDs, Serialization, and Validation Primitives
Last completed phase: `ARGOV-P01` - Governance Package Skeleton and Canonical Naming
...
Note: Projected after ARGOV-P01 merge.
