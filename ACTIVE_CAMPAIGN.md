...
Current phase: `ASV1-P23` - ML and Factor Combination MVP
Last completed phase: `ASV1-P22` - Experiment Registry Hardening
Last completed status: `PASS_WITH_WARNINGS`
Passing phases: `23/30`
...
Note: Projected after ASV1-P22 merge.
