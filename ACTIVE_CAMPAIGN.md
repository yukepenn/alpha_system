...
Current phase: `ASV1-P21` - Management Grid Engine
Last completed phase: `ASV1-P20` - Strategy Grid Engine MVP
Last completed status: `PASS_WITH_WARNINGS`
Passing phases: `21/30`
...
Note: Projected after ASV1-P20 merge.
