...
Current phase: `ARGOV-P04` - HypothesisCard and Pre-registration Protocol
Last completed phase: `ARGOV-P03` - AlphaSpec Contract and No-Code Gate
...
Note: Projected after ARGOV-P03 merge.
