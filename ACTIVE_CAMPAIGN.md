...
Current phase: `ARGOV-P08` - TrialLedger and Variant Accounting
Last completed phase: `ARGOV-P07` - StudySpec and Study Budget Protocol
...
Note: Projected after ARGOV-P07 merge.
