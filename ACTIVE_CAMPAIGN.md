...
Current phase: `ASV1-P22` - Experiment Registry Hardening
Last completed phase: `ASV1-P21` - Management Grid Engine
Last completed status: `PASS_WITH_WARNINGS`
Passing phases: `22/30`
...
Note: Projected after ASV1-P21 merge.
