...
Current phase: `ASV1-P05` - SQLite Metadata Registry MVP
Last completed phase: `ASV1-P04` - Core Contracts and Schema Primitives
...
Note: Projected after ASV1-P04 merge.
