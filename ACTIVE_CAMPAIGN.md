...
Current phase: `DATA-P14` - Parser and Parsed Bar Records
Last completed phase: `DATA-P13` - Roll Policy and Roll Calendar
Last completed status: `PASS_WITH_WARNINGS`
Passing phases: `14/25`
...
Note: Projected after DATA-P13 merge.
