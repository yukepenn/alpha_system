...
Current phase: `ASV1-P17` - Position Management Module
Last completed phase: `ASV1-P16` - Cost, Slippage, and Conservative Execution Semantics
Last completed status: `PASS_WITH_WARNINGS`
Passing phases: `17/30`
...
Note: Projected after ASV1-P16 merge.
