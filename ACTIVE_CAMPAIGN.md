...
Current phase: `ASV1-P13` - Factor Card and Report Generation
Last completed phase: `ASV1-P12` - Intraday Factor Diagnostics Engine
Last completed status: `PASS_WITH_WARNINGS`
Passing phases: `13/30`
...
Note: Projected after ASV1-P12 merge.
