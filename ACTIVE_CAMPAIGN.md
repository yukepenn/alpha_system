...
Current phase: `ARGOV-P12` - ReviewerVerdict and Independence Rules
Last completed phase: `ARGOV-P11` - PromotionDecision and PromotionGate State Machine
Last completed status: `PASS_WITH_WARNINGS`
Passing phases: `12/20`
...
Note: Projected after ARGOV-P11 merge.
