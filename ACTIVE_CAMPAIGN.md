...
Current phase: `ASV1-P28` - Researcher and AI Agent Onboarding
Last completed phase: `ASV1-P27` - Review Bundles, Source Maps, and Audit Reports
Last completed status: `PASS_WITH_WARNINGS`
Passing phases: `28/30`
...
Note: Projected after ASV1-P27 merge.
